            ...
            <div class="col-12 col-lg-8">
                <div class="blog-news-area">
                    ...
                    <div class="single-blog-post-area wow fadeInUp" data-wow-delay="200ms">
                        <!-- Post Thumb -->
                        <a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/bg-img/37.jpg" alt=""></a>
                        <!-- Post Meta -->
                        ...
                        <p>One of the most important parts of any healthy lifestyle, though, is a willingness to learn
                            from those who’ve already been around for a bit. It seems like a good place to start. You
                            might notice there’s a bit of a variety, almost as if one lifestyle doesn’t fit all.</p>
                        <!-- Post Author Meta -->
                        <div class="post--author-meta d-flex justify-content-between">
                            <a class="news-btn" href="#">Read More <i class="fa fa-angle-double-right"
                    ...
                    <div class="single-blog-post-area wow fadeInUp" data-wow-delay="200ms">
                        <!-- Post Thumb -->
                        <a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/bg-img/38.jpg" alt=""></a>
                        <!-- Post Meta -->
                    ...
                    <div class="single-blog-post-area wow fadeInUp" data-wow-delay="200ms">
                        <!-- Post Thumb -->
                        <a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/bg-img/39.jpg" alt=""></a>
                        <!-- Post Meta -->
                        <div class="post-meta mt-40 mb-15">
                    ...
                    <div class="single-blog-post-area wow fadeInUp" data-wow-delay="200ms">
                        <!-- Post Thumb -->
                        <a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/bg-img/40.jpg" alt=""></a>
                        <!-- Post Meta -->
                        <div class="post-meta mt-40 mb-15">
                            <a class="post-author" href="#">By Mattie Ramirez</a>
                            <a class="post-date" href="#">Dec 19, 2019</a>
                ...
                <div class="rehomes-pagination-counter mb-100 d-flex flex-wrap justify-content-between align-items-center wow fadeInUp"
